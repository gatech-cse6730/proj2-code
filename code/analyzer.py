...
class Analyzer(object):
    ...
    def prepare_plots(self):
        ...
        self.result_dict = {200: {'ci': 61.818194103387398, 'mean_stdev': 243.4039887309462}, 1250: {'ci': 2.157872180249738, 'mean_stdev': 52.349627034556207}, 100: {'ci': 8.9023215324361935, 'mean_stdev': 84.507699620623569}, 1000: {'ci': 3.2219210610598248, 'mean_stdev': 75.888702713003539}, 50: {'ci': 14.483541995694903, 'mean_stdev': 61.225696451918004}, 500: {'ci': 4.0779799440094031, 'mean_stdev': 111.15924942621139}, 150: {'ci': 23.533732825847604, 'mean_stdev': 213.08938278679028}, 250: {'ci': 6.3941709408915743, 'mean_stdev': 160.80310029499523}, 400: {'ci': 5.9846148376286763, 'mean_stdev': 136.27323783261383}, 300: {'ci': 21.775493254610492, 'mean_stdev': 184.25969976371289}}

        for initial_pop in a:
...
if __name__ == '__main__':
    ...
    analyzer.prepare_results(initial_pops=[50,100,150,200,250,300,400,500,1000,1250])
